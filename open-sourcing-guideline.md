# Things to consider when open sourcing
  ...
  - Security
    ...
    - Make sure the code does not expose any security vulnerabilities. If it's a Rails project please refer to this [guideline](http://www.veracode.com/security/ruby-security/) and make sure [brakeman](https://github.com/presidentbeef/brakeman) does not highlight any problems. If it's a non Rails project see [this](http://www.toptal.com/security/10-most-common-web-security-vulnerabilities).
